...
import '@modules/prepress/frontend/CreateJob.css' // Mapped directly to CreateJob CSS to maintain elite UI
import './WhatsAppJob.css' // Scoped overrides: larger inputs for standalone intake form
        ...
        <div className="create-job-page" style={{ paddingBottom: '5rem' }}>
            ...
            <div className="create-job-container" style={{ maxWidth: '1600px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.2fr) minmax(0, 420px)', gap: '2rem', alignItems: 'start' }}>
                    <div className="create-job-card whatsapp-intake">
